variable "project_name" {
  ...
  default     = "Azure Terraform Project"
}
...
variable "storage_account_name" {
  ...
  default     = "azterrafORMstorage01## should be formated to be all lowercase"
}
...
variable "vm_size" {
  ...
  validation {
    ...
    error_message = "The vm size must be between 2 and 20 characters"
  }
  validation {
    condition     = strcontains(lower(var.vm_size), "standard")
    error_message = "The vm size must start with 'Standard'"
  }
}
